...
?>
    <div class="container formulaire">
      ...
      <form class="form-signin" method="post" action="loginutilisateur.php">
        ...
        <button class="btn btn-lg btn-primary btn-block" type="submit" name="btnSub" value="SeConnecter">Se connecter</button>
      </form>
